  ...
  const Header = ({ isSpecial = false }: { isSpecial?: boolean; }) => {
    return <div className={cn('w-full', isSpecial && 'block lg:hidden')}>
      <div className='flex items-center'>
        <p className='ml-[4rem] lg:ml-0 text-[14px] font-medium tracking-[2%]'>GoalGalaxy 2024</p>
      ...
      <p className='w-full text-center lg:w-max lg:text-start mt-[2rem] font-semibold text-gray-500'>GoalGalaxy Full</p>
